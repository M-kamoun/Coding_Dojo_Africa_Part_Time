...
<form:form action="/addBurger" mode="post" modelAttribute="burger">
	...
	<div>
		...
		<form:errors path="restaurant" class="text-danger"/><br>
		<form:input path="restaurant" style="width:250px;"/><br>
		
	</div>
	<div>
		<form:label path="rating">Rating:</form:label><br>
		<form:errors path="rating" class="text-danger"/><br>
		<form:input path="rating" style="width:250px;"/><br>
	</div>
	<div>
		<form:label path="notes">Notes:</form:label><br>
		<form:errors path="notes" class="text-danger"/><br>
		<form:textarea path="notes" rows="3" style="width:250px;"/><br>
	</div>
	<div>
