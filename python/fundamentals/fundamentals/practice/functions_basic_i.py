...
# output: error  function number_of_days_in_a_week_silicon_or_triangle_sides() definded
...
def add(b,c):
    print(b+c)
print(add(1,2) + add(2,3)) #3 -- 5   error operator + withe NoneType
